  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 p-6">
        {/* Header */}
        <h2 className="text-2xl font-bold mb-6">Details Rental</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-lg font-semibold">
              {rentalData.car.name}{" "}
              <span className="text-gray-500">{rentalData.car.id}</span>
            </h3>
            <p className="text-sm text-gray-500">{rentalData.car.type}</p>
            {/* Pick-Up */}
            <div className="mt-4">
              <p className="font-semibold text-blue-600">Pick-Up</p>
