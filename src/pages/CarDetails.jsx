  ...
  return (
    <div className=" mx-auto p-6 bg-gray-100 dark:bg-gray-800">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 ">
        ...
        <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md sm:p-6 p-2">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 mb-2">
          ...
          <p className="text-xs sm:text-base text-gray-600 dark:text-gray-300 mb-4 mb-2 break-words">
            {car?.description}
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4 mb-4 mb-2">
            <p className="text-xs sm:text-base text-gray-600 dark:text-gray-300 mb-2 mb-1">
              TypeCar{" "}
              <span className="text-black dark:text-gray-300 font-medium ml-1 sm:ml-4">
                {car?.car_type}
              </span>
            </p>
            <p className="text-xs sm:text-base text-gray-600 dark:text-gray-300 mb-2 mb-1">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mt-2 sm:mt-4">
            <p className="text-lg sm:text-2xl font-bold text-gray-900 dark:text-white mb-2 sm:mb-0">
            ...
            <button
              ...
              className="bg-blue-500 text-white px-2 py-1 sm:px-4 sm:py-2 text-xs sm:text-base rounded hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700"
            >
              Rent Now
            </button>
          </div>
