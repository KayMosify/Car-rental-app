...
const CarListingHero = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 lg:gap-10 p-4 md:p-10 max-w-screen mx-auto">
      {/* First Card */}
      <div className="w-full h-[400px] md:w-1/2 bg-blue-400 rounded-xl p-6 md:p-10  text-white relative overflow-hidden">
      ...
      {/* Second Card */}
      <div className="w-full h-[400px] md:w-1/2 bg-blue-600 rounded-xl p-6 md:p-10  text-white relative overflow-hidden">
        <div className="z-10 relative">
          <h2 className="text-3xl md:text-4xl font-bold leading-tight mb-3">
          ...
          <button className="bg-blue-500 hover:bg-blue-400 text-white font-medium py-2 px-6 rounded-lg">
            Rental Car
          </button>
        </div>
        <div className="absolute bottom-4 right-4 md:right-8 flex justify-center items-center">
